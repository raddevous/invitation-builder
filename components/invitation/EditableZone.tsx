...
export default function EditableZone({
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 border-2 border-dashed border-transparent group-hover:border-[#6998EE]/70 transition-colors rounded-xl pointer-events-none z-10" />
      {/* Edit button */}
      <div className="absolute top-2 right-2 bg-white/95 rounded-full p-1.5 shadow-lg opacity-0 group-hover:opacity-100 transition-all scale-75 group-hover:scale-100 z-20 pointer-events-none">
        <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#6998EE" strokeWidth="2.5">
