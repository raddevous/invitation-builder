      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full p-6">
        ...
        <div className="mb-6">
          ...
          <input
            ...
            className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-[#6998EE]"
          />
        ...
        <div className="flex gap-3 justify-between">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={handleSave}
              className="px-4 py-2 bg-[#6998EE] text-white rounded-lg text-sm hover:bg-[#a67968] transition-colors"
            >
              Save Crop
            </button>
          </div>
