  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-rose-blush px-6 text-center"
      ...
      <div className="max-w-md">
        <p className="text-sm tracking-[0.3em] uppercase mb-4" style={{ color: "#6998EE", fontFamily: "Cormorant Garamond, serif" }}>
          Digital Invitations
        </p>
        ...
        <div className="flex flex-col gap-4 items-center">
          <Link
            ...
            style={{ backgroundColor: "#6998EE", fontFamily: "Cormorant Garamond, serif", fontSize: "1.1rem" }}
          >
            Edit My Invitation
          </Link>
          <Link
            ...
            style={{ borderColor: "#6998EE", color: "#6998EE", fontFamily: "Cormorant Garamond, serif", fontSize: "1.1rem" }}
          >
            Try Demo
          </Link>
        </div>
